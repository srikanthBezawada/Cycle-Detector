...
public class CycleHelp extends javax.swing.JFrame {
    ...
    public void setText(int buttonNumber) {
        ...
        helpString =
                ...
                + "----\n"
                + "About : \n\n"
                + " Cycle detector detects cycles in the current network  \n"
                + " and creates subnetworks of the cycles \n"
                + "\n"
                + "\n"
                + "Tutorial : \n"
                + " - Click on Apps menu \n"
                + " - Click on Cycle Detector 1.0 which opens \n"
                + "   a tabbed panel in control panel \n"
                + " - Select the network to be used \n"
                + "   and select if network is directed \n"
                + " - Click on the Run button \n\n"
               
                + "Results : \n"
                + " - Find the new subnetworks of cycles created from control panel \n"
                + "----\n";
        
                

        this.setTitle("Cycle Detector Help : ");
