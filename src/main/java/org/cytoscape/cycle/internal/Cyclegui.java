...
import org.cytoscape.cycle.internal.logic.CycleLogic;
 ...
 */
public class Cyclegui extends javax.swing.JPanel implements CytoPanelComponent {

    /**
     * Creates new form CliqueUI
     */
    private CycleCore core; 
    public Cyclegui(CycleCore core) {
        initComponents();
        this.core = core;
        updateNetworkList();
    }
    ...
    private void initComponents() {
        ...
        UndirectedB = new javax.swing.JRadioButton();
        DirectedB = new javax.swing.JRadioButton();
        ...
        headingLabel.setText("Cycle Detector");

        networkPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Select the network"));

        netVariable1.setText("Network");

        yesNoPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Select the type of network"));

        buttonGroup1.add(UndirectedB);
        UndirectedB.setSelected(true);
        UndirectedB.setText("UnDirected");

        buttonGroup1.add(DirectedB);
        DirectedB.setText("Directed");
        ...
        yesNoPanelLayout.setHorizontalGroup(
            ...
            .addGroup(yesNoPanelLayout.createSequentialGroup()
                .addGap(17, 17, 17)
                .addComponent(UndirectedB)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(DirectedB)
                .addGap(19, 19, 19))
        );
        ...
        startB.setText("Find Cycles in the current network");
    ...
    private void startBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startBActionPerformed
        ...
        CycleLogic logicThread;
        if(currentnetwork != null){
            currentnetworkview = CyActivator.getCyApplicationManager().getCurrentNetworkView();
            logicThread = new CycleLogic(this, currentnetwork, currentnetworkview, UndirectedB.isSelected());
            logicThread.start();
        } else{
    ...
    public void startComputation(){
        ...
        statusLabel.setText("Detecting Cycles ......");
    }
    
    public void endComputation(){
        statusBar.setIndeterminate(false);
        statusLabel.setText("<html> Completed finding cycles in the current network ! <br> You might want to recompute with different inputs <html>");
    ...
    private javax.swing.JRadioButton DirectedB;
    private javax.swing.JRadioButton UndirectedB;
